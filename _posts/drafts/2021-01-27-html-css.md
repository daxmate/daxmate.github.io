...
在JetBrains的Academy做Frontend的练习，因为学习得太快了，很多东西没有掌握，后面做实操的时候感觉很痛苦。还是乖乖的拿本书慢慢的学吧。
...
- head标签中可以包含
  ...
  - meta 这个里面的信息不是显示给用户的，而是主要面向搜索引擎的。[这里](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta)有完整的支持的属性列表。**meta标签不需要闭合。**
